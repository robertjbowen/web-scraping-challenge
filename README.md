...
Missions_to_Mars directory - Folder containing all of the project code
...
images directory - contains images of the WebPage outputs and scrape sources for display in the ReadMe
